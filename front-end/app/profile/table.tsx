	...
	return (
		<React.Fragment>
			<TableRow
				...
				<TableCell
					className="border-l-5 border-l-gray-50"
					sx={{fontSize: '1.25rem', lineHeight: '1.75rem'}}>
						...
						{row.applicationStatus === 'Certified' ? (
							<svg
								...
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
									d="M10.125 5.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 5.25h.375a9 9 0 019 9v.375M10.125 5.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 5.25L15 12"
								/>
							</svg>
						) : null}
				...
				<TableHead>
					<TableRow className="w-full">
						<TableCell
							...
							className="bg-blue-50 border-r-5 border-gray-50 w-5/3">
							Event Name
						</TableCell>
						<TableCell
							sx={{fontWeight: '700', fontSize: '1.25rem', lineHeight: '1.5rem'}}
