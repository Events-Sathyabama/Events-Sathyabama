		...
		<div className="flex flex-col w-full justify-center items-center">
			...
			<div className="flex flex-col w-11/12 items-center my-5 gap-5 min-h-[80vh] justify-center">
				{url === '' ? (
					...
					<div className="flex flex-col justify-center p-8 items-center min-w-[60vw] min-h-[60vh] shadow-md rounded-xl border border-gray-300">
						<blockquote className="relative">
							...
							<div className="relative z-10">
								<p className="text-gray-800 -mt-1 text-xl text-center">
									Thanks for contributing to <span className='font-semibold'>Events@Sathyabama</span>.{' '}
									<br></br> You can track the status of your issue (or) enhancement
									at:
								</p>
							</div>
						</blockquote>
