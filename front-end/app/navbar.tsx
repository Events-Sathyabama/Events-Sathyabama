...
export default function Navbar() {
	...
	return (
		<Disclosure
			as="div"
			className="border-b-2 border-gray-200 sticky top-0 z-40 backdrop-filter backdrop-blur-md" // HACK has z-index
		>
			{({open}) => (
				<>
							...
							<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
								...
								<Menu as="div" className="relative ml-3">
									...
									<Transition
										...
										<Menu.Items 
										className="absolute right-0 z-40 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" // HACK z-index
										>
											<Menu.Item>
												{({active}) => (
													<Link
