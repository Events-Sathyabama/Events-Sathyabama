		...
		<ol className="flex flex-col md:flex-row my-3 mx-2">
			<li className="relative mb-6 sm:mb-0">
				...
				<div className="flex flex-col items-center -mt-2 justify-center md:justify-start md:items-start md:mt-3 md:pr-8">
					...
					<p className="font-normal text-lg text-gray-600">{props.dates}</p>
				</div>
			</li>
			<li className="relative mb-6 sm:mb-0">
				<div className="flex items-center sm:mt-2">
				...
				<div className="flex flex-col items-center -mt-2 justify-center md:justify-start md:items-start md:mt-3 md:pr-8">
					...
					<p className="font-normal text-lg text-gray-600">{props.time}</p>
				</div>
			</li>
			<li className="relative mb-6 sm:mb-0">
				<div className="flex items-center sm:mt-2">
				...
				<div className="flex flex-col items-center -mt-2 justify-center md:justify-start md:items-start md:mt-3 md:pr-8">
					...
					<p className="font-normal text-lg text-gray-600">{props.venue}</p>
				</div>
			</li>
		</ol>
	);
