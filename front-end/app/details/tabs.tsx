    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      <TabContext value={value}>
        ...
        <TabPanel value='1'>
          ...
          adipisicing elit. Nihil vero ab vel optio, illo et esse? Error
          repellendus enim corrupti deserunt, ipsam earum suscipit magnam ipsa
          dignissimos temporibus quisquam inventore, labore culpa nostrum
          mollitia similique eos libero accusantium necessitatibus dolor
          quibusdam cupiditate. Excepturi, quos nulla aliquam fugiat asperiores
          architecto corrupti.
        </TabPanel>
        <TabPanel value='2'>
