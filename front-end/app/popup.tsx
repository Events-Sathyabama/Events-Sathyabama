...
function Error(props: {message: string; showpopup: Function}) {
	return (
		<div
			id='toast-danger'
			className='flex items-center w-full max-w-xs p-4 m-3 text-black border border-blue-500 bg-white rounded-lg shadow-md'
			role='alert'>
